...
trees = 10000
# infiles = glob.glob('transfLearning/image_vectors/*.npz')

def build_ann_index(path="transfLearning/image_vectors/*.npz", dims=2048):
  t = AnnoyIndex(dims)
...
def nearest_neighbors(index, feature_vector, n_neighbors=3):
  
  named_nearest_neighbors = []
  nearest_neighbors = index.get_nns_by_vector(feature_vector, n_neighbors)
