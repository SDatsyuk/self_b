...
MODEL_PATH = "transfLearning/NNs/resnetV2_101/"
PB_FILE = 'resnet_v2_101.pb'
  ...
  def run_inference_on_images(self, image_list, output_dir):
    ...
    with self.sess:
      ...
      for image_index, image in enumerate(image_list):
        ...
        feature_tensor = self.sess.graph.get_tensor_by_name('resnet_v2_101/SpatialSqueeze:0')
        feature_set = self.sess.run(feature_tensor,
                        {'input:0': np.expand_dims(image_np, axis=0)})
